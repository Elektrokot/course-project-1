...
def events_page_data(df: pd.DataFrame, date_str: str, period: str = "M") -> str:
    ...
    currency_rates_list: List[Dict[str, Any]] = currency_rates if isinstance(currency_rates, list) else []
    stock_prices_list: List[Dict[str, Any]] = stock_prices if isinstance(stock_prices, list) else []
